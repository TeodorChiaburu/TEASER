...
within ArchetypePWH_2021.AAA_OSZOstpreuendamm40II;
model AAA_OSZOstpreuendamm40II
  "This is the simulation model of AAA_OSZOstpreuendamm40II with traceable ID 37"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 23677.499999999996,
    ABuilding=6765.000000000001,
    ASurTot=33707.84947942103,
    numZones = 7,
    internalGainsMode = 1,
        use_C_flow = false,
    ...
    zoneParam = {
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Office(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Floor(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Storage(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Meeting(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Restroom(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_ICT(),
      AAA_OSZOstpreuendamm40II_DataBase.AAA_OSZOstpreuendamm40II_Laboratory()
      },
  heatAHU=true,
  coolAHU=true,
  dehuAHU=true,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_2021/AAA_OSZOstpreuendamm40II/InternalGains_AAA_OSZOstpreuendamm40II.txt"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_2021/AAA_OSZOstpreuendamm40II/AHU_AAA_OSZOstpreuendamm40II.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_2021/AAA_OSZOstpreuendamm40II/TsetHeat_AAA_OSZOstpreuendamm40II.txt"),
    columns=2:8)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://ArchetypePWH_2021/AAA_OSZOstpreuendamm40II/TsetCool_AAA_OSZOstpreuendamm40II.txt"),
      columns=2:8)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/AAA_OSZOstpreuendamm40II/AAA_OSZOstpreuendamm40II.mos"
      "Simulate and Plot"),
