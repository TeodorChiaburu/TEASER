...
model AAA_DEZENTRAL_OSZPappelallee3031Schule
  "This is the simulation model of AAA_DEZENTRAL_OSZPappelallee3031Schule with traceable ID 98"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Office(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Floor(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Storage(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Meeting(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Restroom(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_ICT(),
      AAA_DEZENTRAL_OSZPappelallee3031Schule_DataBase.AAA_DEZENTRAL_OSZPappelallee3031Schule_Laboratory()
      },
  heatAHU=true,
  coolAHU=true,
  dehuAHU=true,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_allhidDIN/AAA_DEZENTRAL_OSZPappelallee3031Schule/InternalGains_AAA_DEZENTRAL_OSZPappelallee3031Schule.txt"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_allhidDIN/AAA_DEZENTRAL_OSZPappelallee3031Schule/AHU_AAA_DEZENTRAL_OSZPappelallee3031Schule.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypePWH_allhidDIN/AAA_DEZENTRAL_OSZPappelallee3031Schule/TsetHeat_AAA_DEZENTRAL_OSZPappelallee3031Schule.txt"),
    columns=2:8)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://ArchetypePWH_allhidDIN/AAA_DEZENTRAL_OSZPappelallee3031Schule/TsetCool_AAA_DEZENTRAL_OSZPappelallee3031Schule.txt"),
      columns=2:8)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/AAA_DEZENTRAL_OSZPappelallee3031Schule/AAA_DEZENTRAL_OSZPappelallee3031Schule.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end AAA_DEZENTRAL_OSZPappelallee3031Schule;
